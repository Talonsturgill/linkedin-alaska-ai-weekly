...
The Alaska Plan is a 10-year, $1.5 billion federal universal service program that let thirteen Alaska mobile and rate-of-return carriers negotiate individualized performance plans instead of facing national cost models. It expires December 31. Five layers determine what comes next.
...
- Alaska Connect Fund September 1 Performance Plan Filing. Mobile ETCs must submit individualized plans to the FCC Wireless Telecommunications Bureau by September 1. Miss the deadline and support ends December 31. No regulatory grace period exists under 47 CFR 54.318.
...
The Alaska Plan was structured as an escape from cost-model discipline in exchange for performance commitments the FCC couldn't enforce. The ADN/ProPublica investigation documents what that produced. The Alaska Connect Fund doesn't repair that structure. It extends it to 2034 with 5G-NR obligations. But the September 1 filing gate is the first moment in a decade where the WTB can condition continued subsidy on a specific forward commitment. Carriers that file get locked into hexagon-level coverage obligations. Carriers that don't file lose hundreds of millions in annualized support and may exit rural markets by January 1.

Any operator or state agency planning rural Alaska AI infrastructure should confirm each carrier's September 1 filing status before committing capital to site selection or service agreements. A carrier exiting the subsidy stack may reprice or discontinue service in marginal-cost rural markets, stranding collocated edge compute or remote sensing investment.

If the WTB Chief conditions approval on 5G coverage commitments deeper than carriers plan to offer, which rural Alaska markets get infrastructure and which get written off as economically unserviceable?
